...
namespace CCity.ViewModel
{
    public class MainViewModel : ViewModelBase
    {
        ...
        public bool SelectedFieldShowsElectricity { get => SelectedFieldNeededElectricity > 0 || IsFieldSelected && _selectedField!.Placeable is PowerPlant; }
        ...
        public bool SelectedFieldIsForest { get => IsFieldSelected && _selectedField!.Placeable is Forest; }
        public int SelectedFieldForestAge { get => SelectedFieldIsForest ? ((Forest)(_selectedField!.Placeable)!).Age : 0; }
        public bool SelectedFieldIsResidentialZone { get => IsFieldSelected && _selectedField!.Placeable is ResidentialZone; }
        public int SelectedFieldResidentialZoneDesireToMoveIn { get => SelectedFieldIsResidentialZone ? PercentToInt(((ResidentialZone)(_selectedField!.Placeable)!).DesireToMoveIn) : 0; }        public int Width { get => _model.Width; }
